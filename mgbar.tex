...
\begin{proof}
\todo{get rid of the beginning of this and cite \label{base_change_okay}
...
space. Being a stable curve is an open condition \citeSP{0E76}.
Hence, we can check locally for each stable curve $C$.
Boundedness holds since $\omega_C^{\otimes 3}$ is very ample.

% i don't think kollar means what the stacks project does for open condition --
% the openness in his sense is vacuous for us. -CL
