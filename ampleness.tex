...
\begin{lemma}[{\cite[\href{http://stacks.math.columbia.edu/tag/0892}{Tag 0892}]{stacks-project}}]
...
By Lemma~\ref{lemma-regular-meromorphic-ideal-denominators},
$\dim(Y_j) < \dim(X)$.
...
ample by Lemma~\ref{lemma-pullback-ample-tensor-relatively-ample} and finite
morphisms are quasi-finite by definition,
$\mathcal{O}_X(mD)$ is ample for $m \gg 0$.
Hence $\mathcal{O}_X(D)$ is ample by Lemma \ref{lemma-ample-power-ample}.
\end{proof}
