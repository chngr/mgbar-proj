...
\begin{proof}
If $\mathcal{L}$ is ample, then $X$ is a scheme by
Lemma~\ref{lemma-relatively-ample-properties}.

Assume $f^*\mathcal{L}$ is ample.
By Lemma~\ref{lemma-relatively-ample-properties}, this implies $Y$ is a scheme.
...
$q^*\mathcal{L}$ is ample on $X \times_{\Spec(R)} Z$.
Thus $\mathcal{L}$ is ample on $X$.
\end{proof}
